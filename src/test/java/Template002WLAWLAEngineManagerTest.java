...
public class Template002WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template002WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template002WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template002WLAIW/InitOutcome.xml").getDocumentElement();
